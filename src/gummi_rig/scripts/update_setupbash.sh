...
#echo ${PWD}
echo "** Updating devel/setup.bash to contain ROS_GUMMI_LEFTBASE enviroment parameter."
echo "## Automatically added by gummi_leftbase_XXX package" >> ../../devel/setup.bash
