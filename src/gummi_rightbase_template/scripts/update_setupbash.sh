...
#echo ${PWD}
echo "** Updating devel/setup.bash to contain ROS_GUMMI_RIGHTBASE enviroment parameter."
echo "## Automatically added by gummi_rightbase_XXX package" >> ../../devel/setup.bash
